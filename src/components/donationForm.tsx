                    ...
                    <div className="sm:col-span-full">
                        ...
                        <div className="mt-2">
                            <input
                                ...
                                className={`block w-full rounded-md bg-transparent border-0 py-1.5 pl-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ${emailTouched && !isValidEmail(email) ? 'ring-2 ring-red-500' : ''}`}
                            />
                        </div>
                    </div>
                    <div className="sm:col-span-3">
                        ...
                        <div className="mt-2">
                            <input
                                ...
                                className={`block w-full rounded-md bg-transparent border-0 py-1.5 pl-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6`}
                            />
                        </div>
                    </div>
                    <div className="sm:col-span-3">
