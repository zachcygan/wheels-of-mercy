      ...
      <section aria-labelledby="features-heading" className="relative">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 sm:pb-32 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:pt-32">
          <div className="lg:col-start-2">
            <div className=''>
              <p className="mt-4 text-4xl font-bold tracking-tight text-gray-900">Founder</p>
              <p className="mt-4 text-gray-500">
                Wheels of Mercy was founded in 2005 by Charles Monson following a transformations near-death
                experience
              </p>
            </div>
            <blockquote className="relative text-center max-w-lg mx-auto pt-10">
