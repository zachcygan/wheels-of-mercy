      ...
      <div className="max-w-5xl mx-auto px-6 pt-14 sm:pt-20 lg:px-8">
        <section aria-labelledby="features-heading" className="relative flex flex-col items-center lg:flex-row">
          ...
          <div className="mx-auto max-w-2xl px-4 pt-16 sm:px-6 sm:pb-32 lg:w-1/2 lg:px-8 lg:pt-20">
            <div className=''>
              <p className={`mt-4 text-4xl font-bold tracking-tight text-center lg:text-left ${robotoFont.className}`}>
                Founder
              </p>
              <p className="mt-4 text-black text-center text-xl lg:text-left">
              ...
              <div className="relative z-10">
                <p className="text-xl text-black">
                  <em className="relative text-accent">
                    <svg className="ml-3 absolute top-0 left-0 transform -translate-x-8 -translate-y-8 h-16 w-16 text-gray-100 sm:h-24 sm:w-24 dark:text-accent" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
